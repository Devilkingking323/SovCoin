    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightTextSOV   = QChar(0xA9)+QString(" 2018 ").arg(COPYRIGHT_YEAR) + QString(tr("Developed by Devilking6105"));
    ...
    pixPaint.drawText(paddingLeft,paddingTop+titleCopyrightVSpace,copyrightTextSOV);
